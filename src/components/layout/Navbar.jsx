                    ...
                    {userMenuOpen && (
                      ...
                      >
                        <div className="px-4 py-3 border-b border-stone-100 dark:border-stone-800">
                          ...
                          <span className={`inline-flex mt-1.5 items-center px-2 py-0.5 rounded-md text-xs font-semibold ${isSeller ? 'bg-teal-100 dark:bg-teal-900/40 text-teal-700 dark:text-teal-400' : 'bg-orange-100 dark:bg-orange-900/40 text-orange-700 dark:text-orange-400'}`}>
                            {isSeller ? '\u{1F3EA} Seller' : '\u{1F6CD}\uFE0F Buyer'}
                          </span>
                        </div>
                        <div className="py-1">
                          {isSeller ? (
                            <>
                              <Link to="/seller/dashboard" onClick={() => setUserMenuOpen(false)} className="flex items-center gap-3 px-4 py-2.5 text-sm text-stone-700 dark:text-stone-300 hover:bg-stone-100 dark:hover:bg-stone-800 transition-colors">
                ...
                {isAuthenticated ? (
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <span className={`text-xs font-medium ${isSeller ? 'text-teal-500' : 'text-orange-500'}`}>
                        {isSeller ? '\u{1F3EA} Seller' : '\u{1F6CD}\uFE0F Buyer'}
                      </span>
                    </div>
                  </div>
